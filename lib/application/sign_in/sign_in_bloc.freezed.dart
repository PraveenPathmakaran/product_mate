...
class _$SignInStateImpl implements _SignInState {
  ...
  @override
  String toString() {
    return 'SignInState(emailAddress: $emailAddress, password: $password, showErrorMessages: $showErrorMessages, authFailureOrSuccessOption: $authFailureOrSuccessOption, isLoading: $isLoading)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, emailAddress, password,
      showErrorMessages, authFailureOrSuccessOption, isLoading);
...
abstract class _SignInState implements SignInState {
  const factory _SignInState(
      ...
      required final Option<Either<AuthFailure, Unit>>
          authFailureOrSuccessOption,
      required final bool isLoading}) = _$SignInStateImpl;
